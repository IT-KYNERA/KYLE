...
|-----------|-------------|
| [overview.md](compiler/overview.md) | Compiler pipeline and stages |
| [cli.md](compiler/cli.md) | Command-line usage |

## Standard library

| Document | Description |
|-----------|-------------|
| [overview.md](standard-library/overview.md) | Standard library reference |
...
| Document | Description |
|-----------|-------------|
| [package-manager.md](tools/package-manager.md) | Using the package manager |
| [formatter.md](tools/formatter.md) | Code formatting |
| [lsp.md](tools/lsp.md) | Language server protocol |
