...
- A single language for all platforms (backend, frontend, desktop, OS)
...
**Positive:**
- Any layer can be replaced independently (e.g., swap Graphics backend)
...
**Negative:**
- More layers mean more abstraction overhead (minimal with native code)
