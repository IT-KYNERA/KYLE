...
fn desugar_variable_decl(v: &VariableDecl) -> VariableDecl {
    VariableDecl {
        ...
        value: Box::new(desugar_expr(&v.value)),
...
fn desugar_expr(expr: &Expr) -> Expr {
    match expr {
        ...
        Expr::StructLiteral { struct_name, fields, span } => Expr::StructLiteral {
...
mod tests {
    ...
    fn dummy_span() -> Span {
        Span {
            file_id: 0,
            start: klc_core::span::Position { line: 1, column: 1, offset: 0 },
            end: klc_core::span::Position { line: 1, column: 1, offset: 0 },
        }
    }
